    ...
    >
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg transform transition-all animate-fadeIn">
        <div className="p-6 border-b flex justify-between items-center">
          <h2 className="text-xl font-semibold text-text-main">Edit Contact</h2>
          <button 
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
                ...
                <input 
                  ...
                  className="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300" 
                  placeholder="Enter tags separated by commas" 
                />
                <p className="mt-1 text-xs text-gray-500">Separate tags with commas (e.g. VIP, Follow-up)</p>
            </div>
            <div>
